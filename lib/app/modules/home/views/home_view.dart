                    ...
                    child: SafeArea(
                      child: StickyHeader(
                        header: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Get.theme.cardColor.withOpacity(.2),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        const Gap(10),
                                        // if (controller.isLocationEnabled)
                                        if (controller.currentWeather?.weather
                                                ?.first.description !=
                                            null)
                                          //   Image.network(
                                          //     'https://openweathermap.org/img/wn/${controller.currentWeather?.weather?.first.icon}@2x.png',
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            if (controller.currentWeather?.humidity != null) const Gap(20),
            ...
            if (controller.currentWeather?.windSpeed != null) const Gap(20),
        ...
        Row(
          ...
          children: [
            ...
            if (controller.currentWeather?.rain?.the1H != null) const Gap(20),
