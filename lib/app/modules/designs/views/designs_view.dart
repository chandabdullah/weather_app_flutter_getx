...
class DesignsView extends GetView<DesignsController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DesignsController>(
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Gap(8),
                  Text(
                    "Choose between all available weather home layouts, including the new Design 3.",
                  ...
                  _DesignOptionCard(
                    title: "Design 1",
                    subtitle:
                        "Glassmorphism dashboard with premium weather sections.",
                    preview: const _ImagePreview(
                      assetPath: 'assets/presentation/faisalabad.png',
                    ),
                    isSelected: controller.designValue == 1,
                  ...
                  _DesignOptionCard(
                    title: "Design 2",
                    subtitle:
                        "Draggable layered layout with summary-first information density.",
                    preview: const _ImagePreview(
                      assetPath: 'assets/design_2/faisalabad.png',
                    ),
                    isSelected: controller.designValue == 2,
                  ...
                  _DesignOptionCard(
                    title: "Design 3",
                    subtitle:
                        "Bold modern dashboard with cleaner sections and fast-scanning metrics.",
                    preview: const _Design3Preview(),
                    isSelected: controller.designValue == 3,
